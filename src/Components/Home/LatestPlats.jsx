...
const LatestPlats = ({latestPlants}) => {
    ...
    return (
       ...
       className='bg-gradient-to-b from-green-50 via-yellow-50 to-green-50 dark:from-[#204e36] dark:via-[#6A8C25] dark:to-[#204e36] py-25'>
        <div className="container mx-auto px-5">
            <motion.h2 key={0} variants={cardVariants} className='text-center text-[#6A8C25] dark:text-white text-4xl md:text-5xl font-bold mb-2'>Latest Plants</motion.h2>
