      ...
      <div className="container mx-auto px-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-15 text-center md:text-start">
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-300 text-base md:text-lg mt-3 mb-8">
              Document your plant's growth journey with photos and measurements
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-300 text-base md:text-lg mt-3 mb-8">
              Track plant health indicators, identify issues early, and get
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-300 text-base md:text-lg mt-3 mb-8">
              Never miss watering, fertilizing, or repotting again. Set custom
              reminders for each plant's unique needs.
            </p>
